        ...
        <Card className="main-card w-full h-32 p-4 flex flex-col justify-start relative gap-2 ">
            ...
            <CardContent className="flex flex-row justify-start items-start p-0">
                <div className="flex flex-col">
                    <h1 className="text-sm font-semibold text-accent-foreground">Total Spend: <span className="text-lg text-secondary-foreground hover:scale-110 transform transition duration-1s">₹{formatNumberWithComma(amount)}</span></h1>
