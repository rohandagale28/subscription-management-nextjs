...
const MenuButton: React.FC<MenuButtonProps> = ({ link, title, component }: MenuButtonProps): ReactElement => {
    ...
    return (
        <div className='w-full'>
            <Button variant="link" className={`flex ${isActive ? 'bg-accent hover:!bg-accent' : ''} flex-row justify-start items-center gap-3  hover:bg-muted w-full rounded-md`} asChild>
                <Link href={link}>
